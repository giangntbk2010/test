...
<head>
    ...
    <title>Chi tiết làm việc trong tháng</title>
        ...
        <div id="rightbodyPan">
            <h2 id='h2User'>
                ...
                if(isset($_REQUEST["date"])){
                    ...
                    $month=date("Y-m",$date);
                    $return=1;
                    echo "<a href= '" . __SITE_PATH . "schedule.php?return=$return&viewDate=$date' title='Quay trở về Đăng kí lịch làm việc'>Chi Tiết";
                    echo " $month   </a>";
                }
                ?>
            </h2>
