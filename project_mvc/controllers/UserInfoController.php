	...
	public function getData() {
		...
		if ($res -> num_rows > 0) {
			...
			while ($row = $res -> fetch_assoc()) {
				...
				$this -> view -> msg .= "<td style='color:darkgreen;'>" . $row['MaPB'] . "</td>";
				$this -> view -> msg .= "</tr>";
				...
				$this -> view -> msg .= "<tr id='row'>";
				$this -> view -> msg .= "<th>" . "Chỉnh Sửa" . "</th>";
				$this -> view -> msg .= "<td><a href='" . __SITE_PATH . 'changePassword.php' . "'>Đổi password</a></td>";
				$this -> view -> msg .= "</tr>";
